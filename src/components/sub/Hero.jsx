...
export default function Hero() {
  return (
    <div className="bg-black relative h-screen text-white p-10 flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <div
          className="absolute animate-gradient top-1/2 -left-1/2 z-20 w-[200%] aspect-square rounded-full border-t-4 border-t-[#d0e8ff] bg-[#0a0a0a] 
